...
readonly PI_COMPATIBILITY='>=0.80.10 <1.0.0'
...
process.exit(match && match[4] === undefined && Number(match[1]) === 0 && (Number(match[2]) > 80 || (Number(match[2]) === 80 && Number(match[3]) >= 10)) ? 0 : 1);
