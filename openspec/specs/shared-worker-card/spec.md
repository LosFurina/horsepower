# shared-worker-card Specification

## Purpose
Define the bounded, private worker-card presentation contract shared by parallel dispatch cards and the interactive worker drawer.
