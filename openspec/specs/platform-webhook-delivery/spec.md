# platform-webhook-delivery Specification

## Purpose
Defines provider-aware, privacy-safe terminal webhook formatting, delivery, diagnostics, and compatibility for generic and Discord incoming webhooks.
